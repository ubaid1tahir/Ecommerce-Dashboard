...
const ProductsScroll = () => {
    ...
    const moveBy = 200; // Adjust the value based on your preference
    ...
    return (
        <>
            <div className="md:mt-36 mt-16 grid grid-cols-2 md:my-10">
                <div>
                    <div className="flex">
                        <svg width="20" height="40" viewBox="0 0 20 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect width="20" height="40" rx="4" fill="#DB4444" />
                        </svg>
                        <p className="ml-4 m-auto text-[#DB4444]">Today’s</p>
                    </div>
                    <div className="mt-6 flex justify-between items-end align-middle">
                        <p className="md:text-lg lg:text-3xl font-semibold tracking-wide">Flash Sales</p>
                        <div className="flex text-end sm:ml-15 md:0">
                            <div className="flex flex-col">
                                <p className="text-xs font-semibold">Days</p>
                                <p className="lg:text-3xl md:text-2xl font-bold">03</p>
                            </div>
                            <div className="flex mx-3 flex-col justify-evenly ">
                                <svg width="4" className="-mb-2" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="2" cy="2" r="2" fill="#E07575" /></svg>
                                <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="2" cy="2" r="2" fill="#E07575" /></svg>
                            </div>
                            <div className="flex flex-col">
                                <p className="text-xs font-semibold">Hours</p>
                                <p className="lg:text-3xl md:text-2xl font-bold">23</p>
                            </div>
                            <div className="flex mx-3 flex-col justify-evenly">
                                <svg width="4" className="-mb-2" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="2" cy="2" r="2" fill="#E07575" /></svg>
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="lg:text-3xl md:text-2xl font-bold">19</p>
                            </div>
                            <div className="flex mx-3 flex-col justify-evenly">
                                <svg width="4" className="-mb-2" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="2" cy="2" r="2" fill="#E07575" /></svg>
                            ...
                            <div className="flex flex-col">
                                ...
                                <p className="lg:text-3xl md:text-2xl font-bold">56</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div className="flex lg:w-[1308px] gap-[30px]" style={sliderStyle}>
                    <div className=''>
                        <div className="bg-[#F5F5F5] relative w-[270px] h-[250px]">
                            <img className='absolute top-[20%] left-[20%]' src={product1} alt="" />
                            <button className='absolute top-[2%] rounded-md left-[4%] px-3 py-1 bg-[#DB4444] text-white'>
                                -40%
                            </button>
                    ...
                    <div className=''>
                        <div className="bg-[#F5F5F5] relative w-[270px] h-[250px]">
                            <img className='absolute top-[20%] left-[20%]' src={product2} alt="" />
                            <button className='absolute top-[2%] rounded-md left-[4%] px-3 py-1 bg-[#DB4444] text-white'>
                                -40%
                            </button>
                            <button className='absolute top-[2%] right-[4%]'>
                    ...
                    <div className=''>
                        <div className="bg-[#F5F5F5] relative w-[270px] h-[250px]">
                            <img className='absolute top-[20%] left-[20%]' src={product3} alt="" />
                            <button className='absolute top-[2%] rounded-md left-[4%] px-3 py-1 bg-[#DB4444] text-white'>
                                -40%
                            </button>
                            <button className='absolute top-[2%] right-[4%]'>
                    ...
                    <div className=''>
                        <div className="bg-[#F5F5F5] relative w-[270px] h-[250px]">
                            <img className='absolute top-[20%] left-[20%]' src={product4} alt="" />
                            <button className='absolute top-[2%] rounded-md left-[4%] px-3 py-1 bg-[#DB4444] text-white'>
                                -40%
                            </button>
                            <button className='absolute top-[2%] right-[4%]'>
                ...
                <div className='my-16 min-w-screen text-center'>
                    <button className='bg-[#DB4444] text-white m-auto px-12 py-4 rounded-md'>View All Products</button>
                </div>
                <hr />
            </div>
        </>
